...
module.exports = {
    ...
    import_file:function(app, return_import){
      ...
      fs.readFile('./senators/list_legant.json', 'utf8', function (err, data) {
        ...
        async.forEachOf(obj_legislators, function(value, key, callback) {
          ...
          app.models[ "legislators_basic" ].create({id_legislator_sil:key, legislator_legislature_sil:value}).exec(function createCB(err, created){
